    ...
    return (
        <ThemeProvider theme={theme}>
            <Box sx={{ display: 'flex' }}>
                ...
                >
                    <Card style={{ flexDirection: 'column', boxShadow: 'none', backgroundColor: '#173F5F' }}>
                        <CardMedia style={{ display: 'flex', justifyContent: 'center', alignContent: 'center' }}>
                            <img src={require('./images/sneha.png')} alt="Sneha Gathani" className={classes.profilePic}/>
                        </CardMedia>
                        <CardContent>
                ...
                <Box
                    component="main"
                    sx={{ flexGrow: 1, bgcolor: '#FFF', p: 3, marginLeft: 270, }}
                >
                    <Container maxWidth="xl" id="about_me" className={classes.Container} style={{ margin: 0, padding: 0, height: '100vh' }}>
                        ...
                        <div style={{ marginLeft: '15px', }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'row' }}>
                                ...
                                <EmojiEventsIcon className={classes.newsIcon1} />
                                <Typography className={classes.newsContent}>
                                     for research that combines science with buisness
                                </Typography>
                            </div> */}
                            <div style={{ display: 'flex', flexDirection: 'row' }}>
                                <CampaignIcon className={classes.newsIcon} />
                    ...
                    <Container maxWidth="xl" className={classes.Container} id="publications" style={{ margin: 0, padding: 0, height: 'auto' }}>
                        ...
                        <Grid container xs={11} style={{ marginBottom: '12px', marginTop: '12px', }}>
                            ...
                            <Grid item style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', alignItems: 'center', }}>
                                <CardMedia
                                    component="img"
                                    image={require('./images/Debugging.png')}
                                    className={classes.cardMediaImage}
                                />
                            </Grid>
                        </Grid>
                    ...
                    <Container className={classes.Container} maxWidth="xl" id="research_interests" style={{ margin: 0, padding: 0, height: 'auto', }}>
                        ...
                        <Typography className={classes.allContent} style={{ marginLeft: '5px', marginTop: '25px', marginBottom: '25px', }}>
                        ...
                        <div data-aos="fade-up" style={{ display: 'flex', justifyContent: 'center', }}>
                            <img className={classes.creativeImage} src={require('./images/research_interest.png')} alt="" width="1000px" />
                        </div>
                        <Divider style={{ marginBottom: '50px', marginTop: '25px' }} />
                    </Container>
                    ...
                    <Container maxWidth="xl" className={classes.Container} id="research" style={{ margin: 0, padding: 0, height: 'auto', }}>
                        ...
                        <Box sx={{ flexGrow: 1, }} className={classes.researchPaper} style={{ marginBottom: '12px', }}>
                            <Grid container spacing={2} style={{ paddingLeft: '15px', }}>
                                <Grid item style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', alignItems: 'center', }}>
                                    <CardMedia
                                        component="img"
                                        image={require('./images/grammatic_embeddings.png')}
                                        className={classes.cardMediaImage}
                                ...
                                <Grid item xs container direction="column" spacing={2} style={{ justifyContent: 'center', }}>
                                    <CardContent sx={{ flex: '1 0 auto' }}>
                                        ...
                                        <Box style={{ display: 'flex', flexDirection: 'row', marginTop: '5px', marginBottom: '5px', }}>
                                            <Button className={classes.keywords} disable>
                                                Visualization Taxonomies
                                            </Button>
                                            {bull}
                        ...
                        <Box sx={{ flexGrow: 1, }} className={classes.researchPaper} style={{ marginTop: '12px', marginBottom: '12px', }}>
                            <Grid container spacing={2} style={{ paddingLeft: '15px', }}>
                                <Grid item style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', alignItems: 'center', }}>
                                    ...
                                    <CardMedia
                                        component="img"
                                        image={require('./images/systemd.png')}
                                        className={classes.cardMediaImage}
                                        style={{ paddingTop: '30px', }}
                                    />
                                </Grid>
                        ...
                        <Box sx={{ flexGrow: 1, }} className={classes.researchPaper} style={{ marginBottom: '12px', marginTop: '12px', }}>
                            <Grid container spacing={2} style={{ paddingLeft: '15px', }}>
                                <Grid item style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', alignItems: 'center', }}>
                                    <CardMedia
                                        component="img"
                                    ...
                                    <CardMedia
                                        component="img"
                                        image={require('./images/traceinspector.png')}
                                        className={classes.cardMediaImage}
                        ...
                        <Typography className={classes.headNames}>Creative</Typography>
                            <Grid item xs={12} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
                                <Box sx={{ m: 2, border: 2, borderColor: '#000' }}>
                                    <img src={require('./images/sunflower.jpeg')} alt="" height="500px" className={classes.creativeImage} />
                                </Box>
                                <Box sx={{ m: 2, border: 2, borderColor: '#000' }}>
                                    <img src={require('./images/tower.png')} alt="" width="735px" className={classes.creativeImage} />
                                </Box>
                            </Grid>
                            <Grid item xs={12} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
                                <Box sx={{ m: 2, border: 2, borderColor: '#000' }}>
                                    <img src={require('./images/ieee.png')} alt="" width="300px" className={classes.creativeImage} />
                                </Box>
                                <Box sx={{ m: 2, border: 2, borderColor: '#000' }}>
                                    <img src={require('./images/tedx.png')} alt="" width="300px" className={classes.creativeImage} />
                                </Box>
                                <Box sx={{ m: 2, border: 2, borderColor: '#000' }}>
                                    <img src={require('./images/cry.png')} alt="" width="400px" className={classes.creativeImage} />
                                </Box>
                            </Grid>
                            <Grid item xs={12} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
                                <Box sx={{ m: 2, border: 2, borderColor: '#000' }}>
                                    <img src={require('./images/stippling.jpg')} alt="" width="350px" className={classes.creativeImage} />
                                </Box>
                                <Box sx={{ m: 2, border: 2, borderColor: '#000' }}>
                                    <img src={require('./images/vase.jpeg')} alt="" width="207px" className={classes.creativeImage} />
                                </Box>
                                <Box sx={{ m: 2, border: 2, borderColor: '#000' }}>
                                    <img src={require('./images/mosac.jpg')} alt="" width="350px" className={classes.creativeImage} />
                                </Box>
                                <Box sx={{ m: 2, border: 2, borderColor: '#000' }}>
                                    <img src={require('./images/lines.jpg')} alt="" width="350px" className={classes.creativeImage} />
                                </Box>
                            </Grid>
                    ...
                    <Container maxWidth="xl" id="contact" className={classes.Container} style={{ margin: 0, padding: 0, height: '100vh' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly' }}>
                            ...
                            <div data-aos="fade-up">
                                <img src={require('./images/sneha.jpg')} alt="" style={{ border: '0.3rem solid #FFD700', }} />
                            </div>
                        </div>
                    </Container>
                </Box>
